<div class="l-sidebar col-xl-3 col-lg-3 col-md-2 col-sm-2 ps-3 pe-3 d-flex flex-column justify-content-between">
            ...
            <li class="l-sidebar__item">
                <a href="explore.php" class="l-sidebar__link">
                    <div class="l-sidebar__icon">
                        ...
                        <svg width="26px" height="26px" viewBox="0 0 24 24" aria-hidden="true" class="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                            <g>
    ...
    <div class="user mt-auto">
        ...
        <div class="user-info">
            <div class="user-main">
                <b class="user-name"><?php echo $user->user_firstName . " " . $user->user_lastName ?></b>
                <span class="user-email">@<?php echo $user->user_userName ?></span>
            </div>
            ...
            <div class="user-logout-content">
                ...
                <div class="user-logout-desc">
                    <div class="user-logout-info">
                        <b class="user-name d-block"><?php echo $user->user_firstName . " " . $user->user_lastName ?></b>
                        <span class="user-email">@<?php echo $user->user_userName ?></span>
                    </div>
                    <div class="user-logout-check">
                        <i class="bi bi-check2-all"></i>
                    </div>
                </div>
            </div>
            <button class="user-logout-btn" name="isLogout" value="true">
                <b>Log out</b> @<?php echo $user->user_userName ?>
                </butt>
        </form>
    </div>
</div>